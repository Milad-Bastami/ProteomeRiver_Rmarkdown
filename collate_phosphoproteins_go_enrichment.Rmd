...
est_num_clusters <- 6
input_plot_width = 10
input_plot_height = 25

cmp_expts_dir <- file.path(results_dir, "Phosphoproteins_Comparisons", "GO_Filtered")
createDirIfNotExists(cmp_expts_dir)


results_path_glob <- file.path(results_dir, "phosphoproteins_go/*/go_enrichment_table_*.tab")
```
