...
input_go_type <- "KEGG"
revigo_cutoff <- 0.9
analysis_type_file_name <- "kegg"
est_num_clusters <- 6
input_plot_width <- 12
input_plot_height <- 15

cmp_expts_dir <- file.path(results_dir, "Phosphoproteins_Comparisons", "KEGG")
createDirIfNotExists(cmp_expts_dir)


results_path_glob <- file.path(results_dir, "phosphoproteins_kegg/*/kegg_enrichment_table_*.tab")
```
