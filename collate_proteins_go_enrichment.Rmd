...
cmp_expts_dir <- file.path(results_dir, "proteomics", "Protein_Enrichment_Comparisons", "GO")
createDirIfNotExists(cmp_expts_dir)

results_path_glob <- file.path(results_dir, "proteomics/de_proteins_go_list/*/go_enrichment_table_*.tab")
...
```{r eval=FALSE}
enrich_revigo <- vroom::vroom( file.path(cmp_expts_dir, paste0( analysis_type_file_name, ".tab") ))
